  ...
  return (
    <section id="profile" className={profileSection}>
      ...
      <div style={{ position: "relative", display: "flex" }}>
        ...
        >
          <Image
            src="https://just-a-website-for-theme.s3.ap-northeast-2.amazonaws.com/mobile/mobile_profile_kong.png"
            alt="법무법인 소울 - 공지연 변호사"
            fill
        ...
        <div style={{ width: "50%", height: 200, position: "relative" }}>
          <Image
            src="https://just-a-website-for-theme.s3.ap-northeast-2.amazonaws.com/mobile/mobile_profile_jeong.png"
